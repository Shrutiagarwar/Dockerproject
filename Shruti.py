...
print("\t\t\tHello World THIS IS DOCKER PROJECT ")
...
while True:
        print("""1. to see date 
press 2 : calander local system
press 3 : web server local
press 4 : create user by name
press 5 : exit from command EXIT 
Press 7 : website joomla 
Press 8 " Stop
        """)
            ...
            if int(ch)==1:
                ...
                if p==1:
                    ...
                    if l==1:
                        ...
                        print("Tell me Your Os container name ")
                        k = input()
                        os.system("docker run -it --name {} Shruti:v1".format(k))
